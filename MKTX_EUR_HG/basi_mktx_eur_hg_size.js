...
function basi_mktx_eur_hg_size_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/EUR_HG_MKTX_BASI_size.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_mktx_eur_hg_size_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'MKTX EUR High Grade BASI by Trade Size',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_eur_hg_mktx_size',
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_mktx_eur_hg_size_container');
    });
...
(function () {
    ...
    basi_mktx_eur_hg_size_chart();
    // $('#basi_mktx_eur_hg_size_container').toggle(true);
