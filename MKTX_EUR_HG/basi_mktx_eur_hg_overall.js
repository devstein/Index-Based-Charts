...
function basi_mktx_eur_hg_overall_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/EUR_HG_MKTX_BASI_overall.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_mktx_eur_hg_overall_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'MKTX EUR High Grade Bid-Ask Spread Index (BASI)',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_eur_hg_mktx_overall',
        ...
        var names = ['MKTX EUR HG BASI', 'MKTX EUR HG BASI Tight','MKTX EUR HG BASI Wide'];
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_mktx_eur_hg_overall_container');
    });
...
(function () {
    ...
    basi_mktx_eur_hg_overall_chart();
    // $('#basi_mktx_eur_hg_overall_container').toggle(true);
