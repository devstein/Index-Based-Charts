...
function basi_mktx_eur_hy_overall_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/EUR_HY_MKTX_BASI_overall.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_mktx_eur_hy_overall_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'MKTX EUR High Yield Bid-Ask Spread Index (BASI)',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_eur_hy_mktx_overall',
        ...
        var names = ['MKTX EUR HY BASI', 'MKTX EUR HY BASI Tight','MKTX EUR HY BASI Wide'];
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_mktx_eur_hy_overall_container');
    });
...
(function () {
    ...
    basi_mktx_eur_hy_overall_chart();
    // $('#basi_mktx_eur_hy_overall_container').toggle(true);
