...
function basi_mktx_us_hy_specialty_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/US_HY_MKTX_BASI_specialty.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_mktx_us_hy_specialty_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'MKTX US High Yield Specialty BASI',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_us_hy_mktx_specialty',
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_mktx_us_hy_specialty_container');
    });
...
(function () {
    ...
    basi_mktx_us_hy_specialty_chart();
    // $('#basi_mktx_us_hy_specialty_container').toggle(true);
