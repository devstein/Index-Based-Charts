...
function basi_trax_gbp_hg_overall_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/GBP_HG_TRAX_BASI_overall.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_trax_gbp_hg_overall_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'TRAX GBP High Grade Bid-Ask Spread Index (BASI)',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_gbp_hg_trax_overall',
        ...
        var names = ['TRAX GBP HG BASI', 'TRAX GBP HG BASI Tight','TRAX GBP HG BASI Wide'];
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_trax_gbp_hg_overall_container');
    });
...
(function () {
    ...
    basi_trax_gbp_hg_overall_chart();
    // $('#basi_trax_gbp_hg_overall_container').toggle(true);
