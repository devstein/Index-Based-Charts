...
function basi_mktx_gbp_hy_sector_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/GBP_HY_MKTX_BASI_sector.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_mktx_gbp_hy_sector_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'MKTX GBP Yield Grade Sector BASI',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_gbp_hy_mktx_sector',
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_mktx_gbp_hy_sector_container');
    });
...
(function () {
    ...
    basi_mktx_gbp_hy_sector_chart();
    // $('#basi_mktx_gbp_hy_sector_container').toggle(true);
