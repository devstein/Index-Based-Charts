...
function basi_trax_gbp_hy_size_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/GBP_HY_TRAX_BASI_size.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_trax_gbp_hy_size_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'TRAX GBP High Yield BASI by Trade Size',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_gbp_hy_trax_size',
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_trax_gbp_hy_size_container');
    });
...
(function () {
    ...
    basi_trax_gbp_hy_size_chart();
    // $('#basi_trax_gbp_hy_size_container').toggle(true);
