...
function basi_trax_eur_hy_sector_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/EUR_HY_TRAX_BASI_sector.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_trax_eur_hy_sector_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'TRAX EUR Yield Grade Sector BASI',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_eur_hy_trax_sector',
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_trax_eur_hy_sector_container');
    });
...
(function () {
    ...
    basi_trax_eur_hy_sector_chart();
    // $('#basi_trax_eur_hy_sector_container').toggle(true);
