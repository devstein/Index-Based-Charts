...
function basi_trace_us_hy_size_chart() {
    //var to catch any issues while getting data 
    var jqxhr_basi = $.get('../../datafiles/widget_data/US_HY_TRACE_BASI_size.csv', function (data) {
        var options = {
            //chart options 
            chart: {
                //set type of graph, where it renders
                type: 'line',
                renderTo: 'basi_trace_us_hy_size_container'
                //was basi_overall_container
            },
            //set title of graph
            title: {
                text: 'TRACE US High Yield BASI by Trade Size',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_basi_us_hy_trace_size',
        ...
        .fail(function (jqxhr_basi, exception) {
           ajaxError(jqxhr_basi, exception, '#basi_trace_us_hy_size_container');
    });
...
(function () {
    ...
    basi_trace_us_hy_size_chart();
    // $('#basi_trace_us_hy_size_container').toggle(true);
